...
Q&A is handled on Slido [here](https://app.sli.do/event/jQy7EZDFaHKahPDyo4cym8/live/questions)

# Discussion session

Day 2 of the symposium features a discussion dession focused on reproducibility and the community.
The shared document for the discussion session can be found [here](https://hackmd.io/@Coconut1019/BJJYscMY6/edit)
