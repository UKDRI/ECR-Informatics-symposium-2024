...
footer: |
  [UKDRI](https://ukdri.ac.uk/) theme for [Quarto Presentations](https://quarto.org/docs/presentations/revealjs/index.html).
...
(@)  Write and publish a registered report outlining the project
(@)  Gather/analyse data
...
[![](images/hope.jpg){width="380"}](https://unsplash.com/photos/man-sitting-on-mountain-cliff-facing-white-clouds-rising-one-hand-at-golden-hour-bH7kZ0yazB0)
:::
